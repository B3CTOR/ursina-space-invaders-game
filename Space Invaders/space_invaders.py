...
main_music = Audio('assets/music.wav', loop = True)

player_texture = load_texture('assets/spaceship.png')
...
alien_texture = load_texture('assets/alien.png')
alien_two_texture = load_texture('assets/alien_two.png')
alien_three_texture = load_texture('assets/alien_three.png')
...
def update():
	...
	if hit_info_player:
		main_music.stop()
		if end == False:
			Audio('assets/explosion.wav')
			Audio('assets/game_over.wav')
			player.x = 99
			player.disable()
